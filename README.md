...
![Installation folder](DEVEL-stage.png?raw=true "C: drive after decompress https://courseware.deepcloudlabs.com/software/DEVEL-stage.2024b-nodejs.mongo.webstorm.zip")
